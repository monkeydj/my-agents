# KBS Principle References

Point-in-time snapshots of the principle files each rule in `rules/` links to via `[[wikilink]]`:

- `decision-gates.md` → [[natural-decision-gates]]
- `dissensus.md` → [[diverge-before-converge]], [[team-diversity]]
- `craft-style.md` → [[solve-right-problem-first]]
