...
- **Log debt**: Each session, note debt found — `# TODO(debt):` inline or ticket.
...
- **Review mindset**: Code reviews = learning. Clarity over cleverness.
...
- **Courage**: Refactor when needed. Don't leave known rot.